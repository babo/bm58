...
def main():
    ...
    parser.add_argument(
        "-U", "--memory", choices=list(range(1, 3)), dest="memory", type=int, help=lang["SettingsMemoryHelp"], default=1
    )

    serialargs = parser.add_argument_group(lang["SettingsGroupBM58"])
    serialargs.add_argument("-F", "--device", dest="device", help=lang["SettingsDeviceHelp"], default="/dev/ttyUSB0")

    formatargs = parser.add_argument_group(lang["SettingsGroupFormat"])
    formatargs.add_argument(
        "-f",
        "--format",
    ...
    formatargs.add_argument("--delimiter", dest="delimiter", help=lang["SettingsDelimiterHelp"], default=",")
    ...
    mysqlargs.add_argument("-t", "--table", dest="table", help=lang["SettingsMYSQLTableHelp"], default="data")
